...
const PublicLessons = () => {
  ...
  const lessons = [
    {
      ...
      description: 'Learning to see failures not as setbacks but as stepping stones to success. This mindset shift changed everything for me.',
    ...
    },
    {
      ...
      description: 'Understanding that saying no to others sometimes means saying yes to yourself. A lesson in boundaries and self-respect.',
      category: 'Mindset',
    ...
    },
    {
      ...
      description: 'How I left a secure corporate job to pursue my passion. The fears, the challenges, and the ultimate reward.',
      category: 'Career',
      emotionalTone: 'Motivational',
    ...
    },
    {
      ...
      description: 'During my darkest days, gratitude became my anchor. Here is how practicing daily gratitude transformed my mental health.',
      category: 'Personal Growth',
    ...
    },
    {
      ...
      description: 'The moment I stopped trying to impress and started being authentic. Quality over quantity in friendships.',
    ...
    },
    {
      ...
      description: 'A costly business decision that taught me more than any success ever could. Sometimes pain is the best teacher.',
  ...
  const filteredLessons = lessons
    .filter(lesson => {
      ...
      const matchesTone = !selectedTone || lesson.emotionalTone === selectedTone;
      return matchesSearch && matchesCategory && matchesTone;
    })
    .sort((a, b) => {
      if (sortBy === 'newest') return new Date(b.createdDate) - new Date(a.createdDate);
      if (sortBy === 'mostSaved') return b.favoritesCount - a.favoritesCount;
      return 0;
    });
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">Explore wisdom and insights shared by our community</p>
        </div>

        {/* Search and Filters */}
        <div className="bg-white rounded-lg border-3 border-black p-6 mb-8" style={{ boxShadow: '6px 6px 0px 0px #000' }}>
        ...
        <p className="text-gray-600 mb-4">
          Showing <span className="font-semibold">{filteredLessons.length}</span> lessons
        </p>
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                <img
                  ...
                  className={`w-full h-full object-cover ${
                    lesson.accessLevel === 'Premium' && !isPremiumUser ? 'blur-sm' : ''
                  }`}
                />
                {lesson.accessLevel === 'Premium' && !isPremiumUser && (
              ...
              <div className="p-5">
                ...
                <div className="flex items-center gap-3 mb-4 pb-4 border-b border-gray-200">
                  ...
                  />
                  <div>
                    <p className="text-sm font-semibold text-gray-800">{lesson.creatorName}</p>
                    <p className="text-xs text-gray-500">{new Date(lesson.createdDate).toLocaleDateString()}</p>
                  </div>
                </div>
        ...
        {filteredLessons.length === 0 && (
          <div className="text-center py-16">
            <p className="text-2xl font-bold text-gray-400 mb-2">No lessons found</p>
